...
class BorrowRoomController extends Controller
{
    ...
    protected function grid()
    {
        ...
        $grid->column('borrow_at', 'Mulai Pinjam(hari)')->display(function ($title, $column) {
            return Carbon::parse($this->borrow_at)->format('d M Y');
        });
        ...
        $grid->column('start_time_at', 'Mulai Jam pinjam');
        $grid->column('end_time_at', 'Selesai Jam Pinjam');
    ...
    protected function detail($id)
    {
        ...
        $show->field('borrow_at', 'Tanggal Mulai Pinjam');
        $show->field('until_at', 'Tanggal Selesai Pinjam');
        $show->field('start_time_at', 'Mulai (jam)');
        $show->field('end_time_at', 'Selesai (jam)');
